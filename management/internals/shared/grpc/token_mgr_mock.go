...
// PushRelayList mocks base method.
func (m *MockSecretsManager) PushRelayList(ctx context.Context, accountID string, peerIDs []string) int {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PushRelayList", ctx, accountID, peerIDs)
	ret0, _ := ret[0].(int)
	return ret0
}

// PushRelayList indicates an expected call of PushRelayList.
func (mr *MockSecretsManagerMockRecorder) PushRelayList(ctx, accountID, peerIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PushRelayList", reflect.TypeOf((*MockSecretsManager)(nil).PushRelayList), ctx, accountID, peerIDs)
}
